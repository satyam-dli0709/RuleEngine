...
//      }
    ...
    public List<String[]> readExcel(@RequestParam String filePath) throws IOException {
    return numberService.readExcel(filePath);
   }

    @PostMapping("/writeExcel")
    public String writeExcel(@RequestParam String filePath, @RequestBody List<Rule> data) throws IOException {
        numberService.writeExcel(filePath, data);
